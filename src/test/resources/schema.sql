...
CREATE OR REPLACE VIEW "ECO_VW_WF_TASK_DETAILS" ("TASK_ID", "INSTANCE_ID", "ASSIGNEE_ID", "ASSIGNEE_ROLE", "ASSIGN_DATE", "ACTION", "ACTION_DATE", "NOTES", "REFUSE_REASONS", "PRODUCT_NAME", "PRICE", "COLOR", "STOCK_QUANTITY", "DESCRIPTION", "STATUS") AS 
  SELECT
    wt."ID" AS TASK_ID,
