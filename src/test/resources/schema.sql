...
CREATE TABLE ECO_WF_ACTIONS (
    ID INT AUTO_INCREMENT PRIMARY KEY,
    ACTION_NAME VARCHAR(20) NOT NULL
);

CREATE TABLE ECO_WF_PROCESSES_GROUPS (
    ID INT AUTO_INCREMENT PRIMARY KEY,
    NAME VARCHAR(255) NOT NULL
);

CREATE TABLE ECO_WF_PRODUCT (
    ID INT AUTO_INCREMENT PRIMARY KEY,
    PRODUCT_ID INT NOT NULL,
    WF_INSTANCE_ID INT NOT NULL
);

CREATE TABLE ECO_WF_PROCESSES (
    ID INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE SEQUENCE  ECO_WF_PRODUCT_SEQ  MINVALUE 1 MAXVALUE 9999999 INCREMENT BY 1 START WITH 1 CACHE 20   NOCYCLE;
