...
CREATE SEQUENCE IF NOT EXISTS ECO_PRODUCT_TRNS_HISTORY_SEQ  
	MINVALUE 1 
...
CREATE SEQUENCE IF NOT EXISTS ECO_WF_PRODUCT_SEQ  
	MINVALUE 1 
	MAXVALUE 9999999 
	INCREMENT BY 1 
	START WITH 1 
...
CREATE OR REPLACE VIEW "ECO_VW_WF_TASK_DETAILS" ("TASK_ID", "INSTANCE_ID", "ASSIGNEE_ID", "ASSIGNEE_ROLE", "ASSIGN_DATE","INSTANCE_STATUS", "ACTION", "ACTION_DATE", "NOTES", "REFUSE_REASONS", "PRODUCT_ID", "PRODUCT_NAME", "PRICE", "COLOR", "STOCK_QUANTITY", "DESCRIPTION", "STATUS") AS 
  SELECT
    wt."ID" AS TASK_ID,
