...
public class ProductServiceImpl implements ProductService {
	...
	if (roleId == RoleEnum.SUPER_ADMIN.getCode() || roleId == RoleEnum.ADMIN.getCode()) {
	    Product product = save(theProduct);
	...
	if (wfProduct == null) {
	    throw new IllegalArgumentException("WFProduct cannot be null");
	}

	return Product.builder()
		.id(wfProduct.getProductId())
		.productName(wfProduct.getProductName())
		.price(wfProduct.getPrice())
		.color(wfProduct.getColor())
		.stockQuantity(wfProduct.getStockQuantity())
		.description(wfProduct.getDescription())
		.build();
